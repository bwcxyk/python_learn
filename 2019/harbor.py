...
class HarborRepos(object):
    ...
    def __init__(self, harbor_domain, harbor_new_domain, password, new_password, schema="http", new_schema="http",
...
if __name__ == "__main__":
    harbor_domain = "192.168.0.2"
    harbor_new_domain = "192.168.11.56"
    re_pass = "Yuanfu1211"
    re_new_pass = "Harbor12345"
    pool = redis.ConnectionPool(host='192.168.1.123', port=6377,
